...
Para mais informações sobre React Hooks, acesse: [https://reactjs.org/hooks](https://reactjs.org/hooks){:target="blank"}.
...
- [Assistir a apresentação do Dan Abramov sobre React Hooks na ReactConf 2018](https://www.youtube.com/watch?v=dpw9EHDh2bM){:target="blank"}.

- [Ler mais a respeito na documentação disponível no site do React](https://reactjs.org/hooks){:target="blank"}.

- [Acompanhar a "awesome list" do React Hooks](https://github.com/rehooks/awesome-react-hooks){:target="blank"}.
