...
Muitos desenvolvedores não conhecem a funcionalidade `Pages` do GitHub. Essa funcionalidade permite que você construa seu site, seu blog ou algum projeto pessoal. Uma de suas características é a possibilidade de fazer deploy de uma aplicação React. Para mais informações sobre o GitHub Pages: [https://pages.github.com/](https://pages.github.com/).
...
Para mais informações sobre o Create React App: [create-react-app](https://github.com/facebookincubator/create-react-app).
...
![a](images/github-repo-settings.png)
...
Quero fazer um agradecimento especial ao meu amigo [Cesar Denis](https://twitter.com/CesarDenis) pelo desenvolvimento do banner desse artigo. Ficou incrível!
